...
### gapLimit(test): [AccountsSynchronizer](#accountssynchronizer)
...
### addressIndex(test): [AccountsSynchronizer](#accountssynchronizer)
...
### accountDiscoveryThreshold(test): [AccountsSynchronizer](#accountssynchronizer)
