...
### consolidateOutputs(test): [Message[]](#message)
...
### generateAddresses(test): [Address[]](#address)
...
### listMessages(test, test, test): [Message[]](#message)
...
### getMessage(test): Optional&lt;[Message](#message)&gt;
...
### getNodeInfo(test, test, test, test): [NodeInfoWrapper](#nodeinfowrapper)
