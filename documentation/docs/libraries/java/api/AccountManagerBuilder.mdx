...
### withStorage(test, test): [AccountManagerBuilder](#accountmanagerbuilder)
...
### withPollingInterval(test): [AccountManagerBuilder](#accountmanagerbuilder)
...
### withOutputConsolidationThreshold(test): [AccountManagerBuilder](#accountmanagerbuilder)
