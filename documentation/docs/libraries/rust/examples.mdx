...
import transaction from  '!!raw-loader!./../../../../examples/05_transaction.rs';
import logger from  '!!raw-loader!./../../../../examples/logger.rs';
import events from  '!!raw-loader!./../../../../examples/events.rs';
...
manager.store_mnemonic(SecretManager::Stronghold, None).await.unwrap();
