...
If you need to reattach a message, you should use the [`iota_wallet.promote(account_id, block_id)`](api_reference.md#promoteaccount_id-block_id-walletmessagewalletmessage) or [`iota_wallet.reattach(account_id, block_id)`](api_reference.md#reattachblock_id-walletmessagewalletmessage) methods, sending your _account_id_ and _block_id_ as arguments.
