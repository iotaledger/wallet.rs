...
import check_balance from  '!!raw-loader!./../../../../bindings/nodejs/examples/binding_examples/3-check_balance.js';
...
import migration from  '!!raw-loader!./../../../../bindings/nodejs/examples/binding_examples/8-migration.js';
