...
import check_balance from  '!!raw-loader!./../../../../bindings/nodejs/examples/3-check-balance.js';
import a_send_amount from  '!!raw-loader!./../../../../bindings/nodejs/examples/4a-send-amount.js';
...
import events from  '!!raw-loader!./../../../../bindings/nodejs/examples/7-events.js';
...
* Other data used by library that is stored under _db_ sub-directory.  The includes account information, generated addresses, fetched blocks, etc. This data is used to speed up some operations, such as account creation, address generation, etc.
...
## Checking Balance
Before we continue further, please visit the [IOTA testnet faucet service](https://faucet.chrysalis-devnet.iota.cafe/) and send to your testnet addresses some tokens.
...
The `Account.send()` function returns a _wallet block_ that fully describes the given transaction. You can use the _blockId_ to check confirmation status. You can retrieve individual blocks related to any given account using the `Account.listBlocks()` function.
