...
existing [`.env.example`](https://github.com/iotaledger/wallet.rs/blob/develop/wallet/bindings/nodejs/examples/.env.example) file. You can
do this running the following command from the `wallet/bindings/nodejs/examples` directory:
...
After you have followed the instructions to [build the library](#build-the-library), you have to run the following command in `wallet/bindings/nodejs/examples`:
