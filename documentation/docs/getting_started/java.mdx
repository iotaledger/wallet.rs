---
description: Get started with the official IOTA Wallet Library Java binding.
...
repository's [code example project ](https://github.com/iotaledger/wallet.rs/tree/develop/bindings/java/iota-wallet-java/examples/src).
