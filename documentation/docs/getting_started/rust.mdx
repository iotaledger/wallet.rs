...
The wallet.rs library is published on [crates.io](https://crates.io/crates/iota-wallet/versions). You can also download the source code from the [official GitHub repository](https://github.com/iotaledger/wallet.rs).
...
To use the library, you first need to create an [`AccountManager`](asd), as shown on lines 7 through 10 in the following example.
