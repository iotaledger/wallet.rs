...
/// Initialize the binding interface.
///
/// # Safety
///
/// Pointers should be valid and not dangling ones.
#[no_mangle]
...
/// Destruct the binding interface.
///
/// # Safety
///
/// Pointers should be valid and not dangling ones.
...
/// Send a message to the binding interface.
///
...
/// Spawn the binding interface thread.
///
/// # Safety
///
/// Pointers should be valid and not dangling ones.
...
// #[no_mangle]
// pub unsafe extern "C" fn iota_init_logger(file_name: *const c_char) {
