...
public class WalletConfig {
    ...
    public JsonObject getJson() {
        ...
        o.addProperty("storagePath", storagePath);
        o.addProperty("clientOptions", clientOptions.getJson().toString());
        o.addProperty("coinType", 4219);
        o.addProperty("secretManager", secretManager.getJson().toString());
    ...
    public static class ClientConfig {
        ...
        public static class Node extends  AbstractObject {

            public Node(JsonObject jsonObject) {
                super(jsonObject);
            }

            public Node(String jsonObject) throws JsonSyntaxException {
                super(jsonObject);
            }
        }
    }
