...
mod tests {
  ...
  fn list_transactions_by_type() {
    ...
    let value_transaction = _generate_transaction(5, account.latest_address().clone(), true, true);
  ...
  fn get_transaction_by_hash() {
    ...
    let mut transaction = _generate_transaction(0, account.latest_address().clone(), true, true);
