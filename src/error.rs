...
pub enum Error {
    ...
    /// migration iota.rs error.
    #[error("`{0}`")]
    ClientMigrationError(Box<iota_migration::client::Error>),
...
impl serde::Serialize for Error {
        ...
        S: Serializer,
    {
        ...
        match self {
            ...
            Self::ClientMigrationError(_) => serialize_variant(self, serializer, "ClientMigrationError"),
